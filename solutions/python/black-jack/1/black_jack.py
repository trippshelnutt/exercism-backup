...
def higher_card(card_one, card_two):
    ...
    if value_of_card_one > value_of_card_two:
        return card_one
    elif value_of_card_two > value_of_card_one:
        return card_two
    else:
...
def value_of_ace(card_one, card_two):
    ...
    value_of_hand = value_of_card_one + value_of_card_two
...
def is_blackjack(card_one, card_two):
    ...
    ten_card_list = ['10', 'J', 'Q', 'K']

    has_ace = card_one == 'A' or card_two == 'A'
    has_ten_card = card_one in ten_card_list or card_two in ten_card_list
